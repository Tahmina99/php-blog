			...
			if(isset($_POST['c_email']))
			{
				try{
					...
					{
						throw new Exception ("message feild can not be empty.");
					}
					if(empty($_POST['c_name']))
					{
						throw new Exception (" name feild can not be empty.");
					}
					if(empty($_POST['c_email']))
					{
						throw new Exception ("email feild can not be empty.");
					}
				...
				throw new Exception("please enter a valid email address.");
					...
					$success_message="Your comment has been sent.It will be published on the website after admin's approved"; 
						}
				catch(Exception $e)
				{
			...
			include('config.php');
				...
				<div class="description">
					<p>
				<a class="fancybox-effects-a" href="uploads/<?php echo $row['post_image']; ?>" title=""><img src="uploads/<?php echo $row['post_image']; ?>" alt="" width="200" style="text-align:center;"/></a>
				...
				<div id="add">
					...
					<div class="form">
						<form action="index2.php?id=<?php echo $id;?>" method="post">
							...
							<input type="image" src="images/button.gif" alt=""  style="width:94px;height:27px;border:0;" />
